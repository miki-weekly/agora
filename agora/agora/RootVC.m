...
-(NSArray*) buttonNames {
        ...
        if (!_buttonNames) {
                _buttonNames =@[@"Browse",@"Education",@"Fashion",@"Home",@"Tech",@"Misc",@"Chat",@"My Posts",@"Community"];
        }
...
-(void) setupButtonView {
        ...
        self.icon = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 100, 120)];
        self.icon.image = [UIImage imageNamed:@"Icon_no_bg"];
        self.icon.contentMode = UIViewContentModeScaleAspectFit;
        CGSize  s = [UIScreen mainScreen].bounds.size;
        self.icon.center = CGPointMake(s.width/2, 60);
        [self.buttonView addSubview:self.icon];
